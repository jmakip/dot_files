...
hi clear
syntax reset
let g:colors_name = "base16-jmakip"
...
call <sid>hi("IncSearch",     s:gui01, s:gui0B, s:cterm01, s:cterm09, "none", "")
...
call <sid>hi("Substitute",    s:gui01, s:gui09, s:cterm01, s:cterm0A, "none", "")
